...
const Sidebar = ({showSidebar, setShowSidebar}) => {
  ...
  <div className={`w-[260px] fixed bg-[#e6e7fb] z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] ease-out duration-300 ${showSidebar ? 'left-0' : '-left-[260px] lg:left-0'} `}>
