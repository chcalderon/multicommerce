...
import { searchRequest } from '../store/reducers/homeReducer';
...
const Header = () => {
    ...
    const { card_product_count, wishlist, wishlist_count } = useSelector(state => state.card)
    ...
    const search = () => {
        dispatch(searchRequest({ category, searchValue }))
        // searchObj.categories = category
    ...
    return (
        <div className='w-full bg-white'>
            ...
            <div className='w-white'>
                <div className='w-[85%] lg:w-[90%] mx-auto'>
                    <div className='h-[160px] md-lg:h-[160px] flex justify-between items-center flex-wrap'>

                        <div className='md-lg:w-full w-3/12 md-lg:pt-4'>
                            <div className='flex justify-between items-center'>

                                <Link to='/'>
                                    <img className='pl-5' src="/images/logo.png" alt="" />
                                </Link>
                                        ...
                                        categorys.map((c, i) => {
                                            return (
                                                <li key={i} className='flex justify-start items-center gap-2 px-[24px] py-[6px]'>
                                                    ...
                                                    <Link to={`/products?categories=${c.name}`} className='text-sm block'>{c.name}</Link>
                                                </li>
                                            )
                                        })
                                    }
