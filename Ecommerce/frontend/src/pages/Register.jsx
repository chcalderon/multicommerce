...
const Register = () => {
    ...
    <a target='_blank' href={import.meta.env.VITE_DASHBOARDURL+"/login"} rel="noreferrer">
     ...
     <a target='_blank' href={import.meta.env.VITE_DASHBOARDURL+"/register"} rel="noreferrer">
